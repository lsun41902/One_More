...
public interface AiClientService {
    // 재료 사진 분석
    List<IngredientAnalysisResponse> analyzeImageIngredients(List<MultipartFile> files, List<String> preferences, String userId);

    // 영수증 사진 분석
    List<IngredientAnalysisResponse> analyzeImageReceipt(List<MultipartFile> files, List<String> preferences, String userId);
