...
public class RecipeValidator {
    ...
    public void validate(MultipartFile file, List<String> preference) {
    ...
    // 공통 검증: 취향 텍스트 길이 제한
    private void checkPreferenceLength(List<String> preference) {
        if (preference != null && preference.size() >= 100) {
